      ...
      VitePWA({
        ...
        manifest: {
          ...
          shortcuts: [
            ...
            { name: 'Immobilien', short_name: 'Immobilien', url: '/#properties', icons: [{ src: '/icons/icon.svg', sizes: 'any' }] },
            { name: 'Finanzen', short_name: 'Finanzen', url: '/#finance', icons: [{ src: '/icons/icon.svg', sizes: 'any' }] },
          ],
