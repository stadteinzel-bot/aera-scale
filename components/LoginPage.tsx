          ...
          >
            ...
            <>
              ...
              <div className="anim-fade anim-d5" style={{ display: 'flex', gap: '10px' }}>
                  ...
                  onClick={async () => {
                    ...
                    try { await loginWithGoogle(); }
                      ...
                      const msg = err?.code === 'auth/popup-closed-by-user'
                        ? 'Anmeldung abgebrochen.' : err?.message || 'Google-Anmeldung fehlgeschlagen.';
                      triggerShake(msg);
                ...
                >
                  {ssoLoading === 'google' ? (
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#4285F4" strokeWidth="2.5" className="animate-spin"><circle cx="12" cy="12" r="10" strokeOpacity="0.25"/><path d="M12 2a10 10 0 0 1 10 10" /></svg>
                  ) : (
                  ...
                  {ssoLoading === 'google' ? 'Wird geladen…' : 'Google'}
                </button>
                ...
                <button
                  ...
                  onClick={async () => {
                    ...
                    try { await loginWithApple(); }
                      ...
                      const msg = err?.code === 'auth/popup-closed-by-user'
                        ? 'Anmeldung abgebrochen.' : err?.message || 'Apple-Anmeldung fehlgeschlagen.';
                      triggerShake(msg);
                    } finally { setSsoLoading(null); }
                  }}
                ...
                >
                  {ssoLoading === 'apple' ? (
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#1d1d1f" strokeWidth="2.5" className="animate-spin"><circle cx="12" cy="12" r="10" strokeOpacity="0.25"/><path d="M12 2a10 10 0 0 1 10 10" /></svg>
                  ) : (
                  ...
                  {ssoLoading === 'apple' ? 'Wird geladen…' : 'Apple'}
                </button>
              </div>
            </>
          </form>
